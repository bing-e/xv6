...
f010004e:	c7 04 24 00 19 10 f0 	movl   $0xf0101900,(%esp)
...
f010008b:	c7 04 24 1c 19 10 f0 	movl   $0xf010191c,(%esp)
...
f01000d1:	00 
f01000d2:	c7 04 24 37 19 10 f0 	movl   $0xf0101937,(%esp)
...
f0100125:	c7 04 24 52 19 10 f0 	movl   $0xf0101952,(%esp)
...
f0100138:	e8 ae 07 00 00       	call   f01008eb <vcprintf>
	cprintf("\n");
f010013d:	c7 04 24 8e 19 10 f0 	movl   $0xf010198e,(%esp)
...
f010016f:	c7 04 24 6a 19 10 f0 	movl   $0xf010196a,(%esp)
...
f0100185:	e8 61 07 00 00       	call   f01008eb <vcprintf>
	cprintf("\n");
f010018a:	c7 04 24 8e 19 10 f0 	movl   $0xf010198e,(%esp)
...
f010042b:	0f b6 82 c0 19 10 f0 	movzbl -0xfefe640(%edx),%eax
...
f0100468:	0f b6 90 c0 19 10 f0 	movzbl -0xfefe640(%eax),%edx
f010046f:	0b 15 28 25 11 f0    	or     0xf0112528,%edx
	shift ^= togglecode[data];
f0100475:	0f b6 88 c0 1a 10 f0 	movzbl -0xfefe540(%eax),%ecx
...
f0100489:	8b 0c 8d c0 1b 10 f0 	mov    -0xfefe440(,%ecx,4),%ecx
...
f01004c3:	75 25                	jne    f01004ea <kbd_proc_data+0x10d>
		cprintf("Rebooting!\n");
f01004c5:	c7 04 24 84 19 10 f0 	movl   $0xf0101984,(%esp)
...
f0100646:	c7 04 24 90 19 10 f0 	movl   $0xf0101990,(%esp)
...
f0100683:	5d                   	pop    %ebp
f0100684:	c3                   	ret    
f0100685:	66 90                	xchg   %ax,%ax
f0100687:	66 90                	xchg   %ax,%ax
...
f01006c5:	f0 
f01006c6:	c7 04 24 84 1c 10 f0 	movl   $0xf0101c84,(%esp)
f01006cd:	e8 4c 02 00 00       	call   f010091e <cprintf>
	cprintf("  etext  %08x (virt)  %08x (phys)\n", etext, etext - KERNBASE);
f01006d2:	c7 44 24 08 f1 18 10 	movl   $0x1018f1,0x8(%esp)
f01006d9:	00 
f01006da:	c7 44 24 04 f1 18 10 	movl   $0xf01018f1,0x4(%esp)
f01006e1:	f0 
f01006e2:	c7 04 24 a8 1c 10 f0 	movl   $0xf0101ca8,(%esp)
...
f01006fd:	f0 
f01006fe:	c7 04 24 cc 1c 10 f0 	movl   $0xf0101ccc,(%esp)
...
f0100719:	f0 
f010071a:	c7 04 24 f0 1c 10 f0 	movl   $0xf0101cf0,(%esp)
...
f0100737:	c7 04 24 14 1d 10 f0 	movl   $0xf0101d14,(%esp)
...
f0100750:	c7 44 24 08 e9 1b 10 	movl   $0xf0101be9,0x8(%esp)
f0100757:	f0 
f0100758:	c7 44 24 04 07 1c 10 	movl   $0xf0101c07,0x4(%esp)
f010075f:	f0 
f0100760:	c7 04 24 0c 1c 10 f0 	movl   $0xf0101c0c,(%esp)
f0100767:	e8 b2 01 00 00       	call   f010091e <cprintf>
f010076c:	c7 44 24 08 40 1d 10 	movl   $0xf0101d40,0x8(%esp)
f0100773:	f0 
f0100774:	c7 44 24 04 15 1c 10 	movl   $0xf0101c15,0x4(%esp)
f010077b:	f0 
f010077c:	c7 04 24 0c 1c 10 f0 	movl   $0xf0101c0c,(%esp)
...
f01007a2:	c7 04 24 68 1d 10 f0 	movl   $0xf0101d68,(%esp)
f01007a9:	e8 70 01 00 00       	call   f010091e <cprintf>
	cprintf("Type 'help' for a list of commands.\n");
f01007ae:	c7 04 24 8c 1d 10 f0 	movl   $0xf0101d8c,(%esp)
...
f01007ba:	8d 7d a8             	lea    -0x58(%ebp),%edi
	...
	while (1) {
		buf = readline("K> ");
f01007bd:	c7 04 24 1e 1c 10 f0 	movl   $0xf0101c1e,(%esp)
...
f01007f1:	c7 04 24 22 1c 10 f0 	movl   $0xf0101c22,(%esp)
...
f0100812:	00 
f0100813:	c7 04 24 27 1c 10 f0 	movl   $0xf0101c27,(%esp)
...
f010083b:	c7 04 24 22 1c 10 f0 	movl   $0xf0101c22,(%esp)
...
f010085d:	c7 44 24 04 07 1c 10 	movl   $0xf0101c07,0x4(%esp)
f0100864:	f0 
...
f0100874:	c7 44 24 04 15 1c 10 	movl   $0xf0101c15,0x4(%esp)
f010087b:	f0 
...
f01008a7:	ff 14 85 bc 1d 10 f0 	call   *-0xfefe244(,%eax,4)
			if (runcmd(buf, tf) < 0)
...
f01008be:	c7 04 24 44 1c 10 f0 	movl   $0xf0101c44,(%esp)
...
f0100a2a:	c7 03 cc 1d 10 f0    	movl   $0xf0101dcc,(%ebx)
	info->eip_line = 0;
f0100a30:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	info->eip_fn_name = "<unknown>";
f0100a37:	c7 43 08 cc 1d 10 f0 	movl   $0xf0101dcc,0x8(%ebx)
...
f0100a57:	b8 26 74 10 f0       	mov    $0xf0107426,%eax
f0100a5c:	3d 09 5b 10 f0       	cmp    $0xf0105b09,%eax
f0100a61:	0f 86 6b 01 00 00    	jbe    f0100bd2 <debuginfo_eip+0x1bd>
f0100a67:	eb 1c                	jmp    f0100a85 <debuginfo_eip+0x70>
  	        panic("User address");
f0100a69:	c7 44 24 08 d6 1d 10 	movl   $0xf0101dd6,0x8(%esp)
f0100a70:	f0 
f0100a71:	c7 44 24 04 7f 00 00 	movl   $0x7f,0x4(%esp)
f0100a78:	00 
f0100a79:	c7 04 24 e3 1d 10 f0 	movl   $0xf0101de3,(%esp)
f0100a80:	e8 73 f6 ff ff       	call   f01000f8 <_panic>
	if (stabstr_end <= stabstr || stabstr_end[-1] != 0)
f0100a85:	80 3d 25 74 10 f0 00 	cmpb   $0x0,0xf0107425
...
f0100a99:	b8 08 5b 10 f0       	mov    $0xf0105b08,%eax
f0100a9e:	2d 04 20 10 f0       	sub    $0xf0102004,%eax
...
f0100ac3:	b8 04 20 10 f0       	mov    $0xf0102004,%eax
...
f0100b07:	8d 90 04 20 10 f0    	lea    -0xfefdffc(%eax),%edx
f0100b0d:	8b 80 04 20 10 f0    	mov    -0xfefdffc(%eax),%eax
f0100b13:	b9 26 74 10 f0       	mov    $0xf0107426,%ecx
f0100b18:	81 e9 09 5b 10 f0    	sub    $0xf0105b09,%ecx
f0100b1e:	39 c8                	cmp    %ecx,%eax
f0100b20:	73 08                	jae    f0100b2a <debuginfo_eip+0x115>
			info->eip_fn_name = stabstr + stabs[lfun].n_strx;
f0100b22:	05 09 5b 10 f0       	add    $0xf0105b09,%eax
...
f0100b57:	05 04 20 10 f0       	add    $0xf0102004,%eax
	while (lline >= lfile
...
f0100b7f:	8b 87 04 20 10 f0    	mov    -0xfefdffc(%edi),%eax
f0100b85:	ba 26 74 10 f0       	mov    $0xf0107426,%edx
f0100b8a:	81 ea 09 5b 10 f0    	sub    $0xf0105b09,%edx
f0100b90:	39 d0                	cmp    %edx,%eax
f0100b92:	73 07                	jae    f0100b9b <debuginfo_eip+0x186>
		info->eip_file = stabstr + stabs[lline].n_strx;
f0100b94:	05 09 5b 10 f0       	add    $0xf0105b09,%eax
...
f0100bb0:	05 04 20 10 f0       	add    $0xf0102004,%eax
		for (lline = lfun + 1;
...
f0100cc6:	e8 e5 0a 00 00       	call   f01017b0 <__umoddi3>
f0100ccb:	89 7c 24 04          	mov    %edi,0x4(%esp)
f0100ccf:	0f be 80 f1 1d 10 f0 	movsbl -0xfefe20f(%eax),%eax
...
f0100dfb:	ff 24 8d 80 1e 10 f0 	jmp    *-0xfefe180(,%ecx,4)
...
f0100ed9:	c7 44 24 08 12 1e 10 	movl   $0xf0101e12,0x8(%esp)
f0100ee0:	f0 
...
f0100f0b:	75 05                	jne    f0100f12 <vprintfmt+0x1ad>
				p = "(null)";
f0100f0d:	bf 02 1e 10 f0       	mov    $0xf0101e02,%edi
			if (width > 0 && padc != '-')
...
f0101214:	c7 04 24 12 1e 10 f0 	movl   $0xf0101e12,(%esp)
...
f0101242:	c7 04 24 f4 1f 10 f0 	movl   $0xf0101ff4,(%esp)
...
f0101679:	5d                   	pop    %ebp
f010167a:	c3                   	ret    
f010167b:	66 90                	xchg   %ax,%ax
f010167d:	66 90                	xchg   %ax,%ax
f010167f:	90                   	nop
...
f01017b7:	8b 44 24 3c          	mov    0x3c(%esp),%eax
...
f01017d4:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f01017d8:	89 f2                	mov    %esi,%edx
f01017da:	75 14                	jne    f01017f0 <__umoddi3+0x40>
f01017dc:	39 f7                	cmp    %esi,%edi
f01017de:	76 40                	jbe    f0101820 <__umoddi3+0x70>
f01017e0:	89 c8                	mov    %ecx,%eax
f01017e2:	f7 f7                	div    %edi
f01017e4:	89 d0                	mov    %edx,%eax
f01017e6:	31 d2                	xor    %edx,%edx
...
f01017ee:	5d                   	pop    %ebp
f01017ef:	c3                   	ret    
f01017f0:	39 f0                	cmp    %esi,%eax
f01017f2:	89 f3                	mov    %esi,%ebx
f01017f4:	77 4a                	ja     f0101840 <__umoddi3+0x90>
f01017f6:	0f bd e8             	bsr    %eax,%ebp
f01017f9:	83 f5 1f             	xor    $0x1f,%ebp
f01017fc:	75 52                	jne    f0101850 <__umoddi3+0xa0>
f01017fe:	39 f0                	cmp    %esi,%eax
f0101800:	0f 82 da 00 00 00    	jb     f01018e0 <__umoddi3+0x130>
f0101806:	39 0c 24             	cmp    %ecx,(%esp)
f0101809:	0f 86 d1 00 00 00    	jbe    f01018e0 <__umoddi3+0x130>
f010180f:	8b 44 24 04          	mov    0x4(%esp),%eax
f0101813:	83 c4 1c             	add    $0x1c,%esp
f0101816:	5b                   	pop    %ebx
f0101817:	5e                   	pop    %esi
f0101818:	5f                   	pop    %edi
f0101819:	5d                   	pop    %ebp
...
f0101824:	75 0b                	jne    f0101831 <__umoddi3+0x81>
...
f010183b:	eb a7                	jmp    f01017e4 <__umoddi3+0x34>
...
f0101877:	8b 54 24 08          	mov    0x8(%esp),%edx
...
f01018a6:	72 08                	jb     f01018b0 <__umoddi3+0x100>
f01018a8:	75 11                	jne    f01018bb <__umoddi3+0x10b>
f01018aa:	39 44 24 08          	cmp    %eax,0x8(%esp)
f01018ae:	73 0b                	jae    f01018bb <__umoddi3+0x10b>
...
f01018e2:	29 f9                	sub    %edi,%ecx
f01018e4:	1b 54 24 0c          	sbb    0xc(%esp),%edx
f01018e8:	89 4c 24 04          	mov    %ecx,0x4(%esp)
f01018ec:	e9 1e ff ff ff       	jmp    f010180f <__umoddi3+0x5f>
